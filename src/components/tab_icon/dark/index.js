...
class DarkTabIcons extends Component {
  handleDarkIcons = () => {
    ...
    if (name === "Assets" && focused) {
      ...
      return (
        <Icon
          source={require("../../../assets/tabs/dark/assets-inactive.png")}
        />
      );
    } else if (name === "Exchange" && focused) {
      return (
        <Icon
          source={require("../../../assets/tabs/dark/exchange-active.png")}
        />
      );
      ...
      return (
        <Icon
          source={require("../../../assets/tabs/dark/transfer-active.png")}
        />
      );
      ...
      return (
        <Icon
          source={require("../../../assets/tabs/dark/settings-active.png")}
        />
      );
  ...
  render() {
    return this.handleDarkIcons();
  }
}

export default DarkTabIcons;
